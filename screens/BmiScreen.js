   ...
   render() {
      return (
         <View style = {styles.container}>
            ...
            <Text style ={styles.resultText}>You are {this.state.BmiResult}</Text>
            <TouchableOpacity onPress={()=>{this.goToDietScreen()}}>
            <Text style={styles.output2}>{"Click here to know about your diet --->"}</Text>
            </TouchableOpacity>
          </View>
      )
   }
